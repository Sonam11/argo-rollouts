...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KapcomTrafficRouting) DeepCopyInto(out *KapcomTrafficRouting) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KapcomTrafficRouting.
func (in *KapcomTrafficRouting) DeepCopy() *KapcomTrafficRouting {
	if in == nil {
		return nil
	}
	out := new(KapcomTrafficRouting)
	in.DeepCopyInto(out)
	return out
}
